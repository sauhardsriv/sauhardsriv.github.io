const siteSettings = {
  ...
  papers: [
    ...
    },
    {
      ...
      citation: 'Vol. 162, Article 104282, 2026.',
  ...
  styles: {
    ...
    card: 'bg-primary-main dark:bg-dark-surface shadow-md rounded-lg p-6 text-primary-text dark:text-dark-text',
    ...
    pdfLink: 'text-primary-url dark:text-dark-url hover:text-primary-url-hover dark:hover:text-dark-url-hover font-extrabold',
    ...
    cvDate: 'text-[14px] text-primary-text dark:text-dark-text opacity-65 dark:opacity-65 leading-relaxed',
    cvDateNote: 'text-xs leading-relaxed opacity-75 dark:opacity-75',
    cvEntryBody: 'space-y-1',
    cvEntryTitle: 'text-[16px] leading-snug font-medium text-primary-text dark:text-dark-text',
    cvEntryInstitution: 'text-[15px] leading-relaxed text-primary-text dark:text-dark-text opacity-65 dark:opacity-70',
    ...
    secondaryText: 'text-primary-text dark:text-dark-text opacity-65 dark:opacity-70',
    metadataLine: 'text-sm text-primary-text dark:text-dark-text opacity-65 dark:opacity-70',
    keywordLine: 'text-xs text-primary-text dark:text-dark-text opacity-60 dark:opacity-60',
    featuredList: 'space-y-5',
    featuredItem: 'border-l-2 border-primary-url/35 dark:border-dark-url/35 pl-4 py-1',
    featuredLabel: 'text-xs uppercase tracking-[0.08em] text-primary-text dark:text-dark-text opacity-55 dark:opacity-50 mb-2',
    featuredTitle: 'text-[16px] leading-snug font-medium',
    featuredSummary: 'mt-2 text-[14px] leading-relaxed text-primary-text dark:text-dark-text opacity-65 dark:opacity-70',
    paperList: 'divide-y divide-primary-text/15 dark:divide-dark-text/20',
    paperItem: 'scroll-mt-24 py-5 first:pt-1 last:pb-1',
    paperTitle: 'text-[16px] leading-snug font-medium text-primary-text dark:text-dark-text',
    paperMeta: 'mt-1 text-[14px] leading-relaxed text-primary-text dark:text-dark-text',
    paperCitation: 'mt-1 text-[14px] leading-relaxed text-primary-text dark:text-dark-text opacity-65 dark:opacity-70',
    paperSecondary: 'mt-1 text-[14px] leading-relaxed text-primary-text dark:text-dark-text opacity-65 dark:opacity-70',
    paperActions: 'mt-2 flex flex-wrap gap-x-3 gap-y-1 text-[14px]',
    subList: 'list-disc ml-6 space-y-1 text-sm text-primary-text dark:text-dark-text opacity-65 dark:opacity-70 font-normal',
    subListPlain: 'list-disc ml-6 space-y-1 text-sm text-primary-text dark:text-dark-text font-normal',
    muted: 'text-primary-text dark:text-dark-text opacity-60 dark:opacity-50',
    italic: 'italic',

    details: {
      root: 'group',
      summary: 'cursor-pointer flex items-center gap-2 text-[14px] text-primary-text dark:text-dark-text',
      ...
      iconSvg: 'w-4 h-4',
      content: 'mt-3 pl-6 text-[14px] text-primary-text dark:text-dark-text opacity-65 dark:opacity-70 leading-relaxed',
    },
    ...
    buttons: {
      themeToggle: 'p-2 rounded-full hover:bg-primary-hover hover:bg-opacity-10 dark:hover:bg-dark-hover dark:hover:bg-opacity-20 transition-all duration-200',
      themeIcon: 'h-5 w-5 text-primary-text dark:text-dark-text',
      backToTop: 'fixed bottom-16 right-8 p-2 rounded-full bg-primary-navbar dark:bg-dark-navbar text-primary-text dark:text-dark-text shadow-lg hover:bg-primary-hover hover:bg-opacity-80 dark:hover:bg-dark-hover dark:hover:bg-opacity-70 transition-all duration-300',
    ...
    notFound: {
      ...
      button: 'flex items-center bg-primary-main dark:bg-dark-surface text-primary-text dark:text-dark-text opacity-80 dark:opacity-70 hover:text-primary-hover dark:hover:text-dark-hover transition-all duration-200 px-6 py-3 rounded-3xl text-lg md:text-xl lg:text-xl font-medium hover:bg-primary-hover hover:bg-opacity-10 dark:hover:bg-dark-hover dark:hover:bg-opacity-20',
